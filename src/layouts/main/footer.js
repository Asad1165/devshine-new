...
const Footer = ({ isDark, isLight }) => {
  ...
  return (
    <Box className="footer">
      <Stack flexDirection="row" justifyContent="center" alignItems="center" width={1}>
        <Box sx={{ maxWidth: { xs: '90%', md: '80%' } }} className="footer__content">
      ...
      <Box
        ...
        sx={{ padding: { sm: '3rem 4% 0.5rem 4%', md: '6rem 4% 0.5rem 4%' } }}
      >
        <Typography variant="caption">Design. Develop. Depart.</Typography>
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} alignItems="center">
          ...
          <Stack direction="row" spacing={3}>
            ...
            <Typography variant="caption">Twitter / X</Typography>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} alignItems="center">
          ...
          <Typography variant="caption">info@wearedepart.com</Typography>
        </Stack>
      </Box>
    </Box>
  );
